...
"""
    THIS PYTHON SCRIPT IS RELATED TO TEST A PARTICULAR COMBINATION OF HYPERPARAMS.
    THE GOAL IS TO TRY OTHER HYPERPARAMS THAT COULD BE INTERESTING.
"""
...
def main() -> None:
    print('Start VQR linear hyperparameters test')
    ...
    for hparam in hparams:
        runs(hparam, name=f'VQR_LINEAR_TEST_HYPERPARAMS_{datetime.today().strftime("%Y%m%d_%H%M%S")}')
    print('End of VQR linear hyperparameters test')
