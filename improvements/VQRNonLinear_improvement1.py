...
def runs(hyperparams: VQR_Hyperparameters,
         name: str = 'VQR_NONLINEAR_test') -> None:
...
def main() -> None:
    ...
    for hparam in hparams:
        runs(hparam, name=f'VQR_NONLINEAR_TEST_HYPERPARAMS_{datetime.today().strftime("%Y%m%d_%H%M%S")}')
    print('End of VQR non-linear hyperparameters test')
