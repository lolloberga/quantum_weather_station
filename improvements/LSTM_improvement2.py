...
"""
    THIS PYTHON SCRIPT IS RELATED TO TEST THE FULL VERSION OF THE DATASET (WITH THE OTHER FEATURES)
    YOU CAN SEE THE FULL DESCRIPTION OF THE TEST HERE: https://trello.com/c/4ORY1KFI/32-lstm-improvement-2
"""
...
RANDOM_STATE = 42
NAME = f'LSTM_#2_{datetime.today().strftime("%Y%m%d_%H%M%S")}'
