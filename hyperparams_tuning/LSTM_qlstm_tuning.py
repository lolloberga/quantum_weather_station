...
def runs(hyperparams: LSTM_Hyperparameters,
         name: str = 'LSTM-QLSTM_TUNING_test') -> None:
...
def main() -> None:
    print('Start LSTM-to-QLSTM hyperparameters tuning')
    ...
    for hparam in hparams:
        runs(hparam, name=f'LSTM-QLSTM_TUNING_{datetime.today().strftime("%Y%m%d_%H%M%S")}')
    print('End of LSTM-to-QLSTM hyperparameters tuning')
