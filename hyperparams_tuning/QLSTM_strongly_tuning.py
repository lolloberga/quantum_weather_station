...
def main() -> None:
    print('Start QLSTM strongly entangler hyperparameters tuning')
    ...
    for hparam in hparams:
        runs(hparam, name=f'QLSTM_STRONGLY_TUNING_{datetime.today().strftime("%Y%m%d_%H%M%S")}')
    print('End of QLSTM strongly hyperparameters tuning')
